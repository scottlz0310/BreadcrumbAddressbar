...
class TestBreadcrumbAddressBar:
    ...
    def test_path_splitting_unix(self):
        ...
        expected = [("/", "/"), ("home", "/home"), ("user", "/home/user"), ("documents", "/home/user/documents")]
    ...
    def test_path_splitting_windows(self):
        ...
        parts = self.addressbar._split_path(test_path)
        expected = [("C:\\", "C:\\"), ("Users", "C:\\Users"), ("User", "C:\\Users\\User"), ("Documents", "C:\\Users\\User\\Documents")]
        assert parts == expected
    ...
    def test_display_items_with_ellipsis(self):
        ...
        path_parts = [
            ...
            ("documents", "/home/user/documents"), ("work", "/home/user/documents/work"),
